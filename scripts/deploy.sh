...
ECR_REPOSITORY="codebuild"
DOCKER_IMAGE_TAG="latest"

# Log in to the ECR registry
aws ecr get-login-password --region ap-south-1 | docker login --username AWS --password-stdin 650691777252.dkr.ecr.ap-south-1.amazonaws.com
